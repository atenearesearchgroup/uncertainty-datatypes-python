    ...
    for n in range(numExecs):
        ...
        if test == TestType.Add:
            for _ in range(repetitions):
                series = series.value + uf1 + uf2 + uf3 + uf4 + uf5 + uf6 + uf7 + uf8     
            ...
            for _ in range(repetitions):
                series = series.value + uf1/uf2/uf2/uf3/uf4/uf5/uf6/uf7/uf8
        elif test == TestType.Exp:
            for _ in range(repetitions):
                series = series.value + uf1**2 + uf2**2 + uf3**3 + uf4**4 + uf5**5 + uf6**6 + uf7**7 + uf8**8
            # END OF COMPUTATION
